...
import { Search, Plus, Menu, User, LogOut, Settings, ChevronDown, ScanBarcode, Store, ShieldCheck } from "lucide-react";
...
export function Header() {
  ...
  const { role, setDemoRole, stores, currentStoreId, setCurrentStoreId, members } = useRole();
